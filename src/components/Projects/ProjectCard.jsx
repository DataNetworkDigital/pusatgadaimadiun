...
import { isShort, rowRemaining } from '../../utils/paymentStatus';
...
export default function ProjectCard({ project, index }) {
  ...
  // What the borrower is short on tagihan he has started paying and that are
  // already due. Money paid ahead into a later tagihan is not a shortfall, and
  // neither is "not yet due", the normal state of a young project.
  const shortfall = (project.payments || [])
    .filter((row) => isShort(project, row))
